...
public class MainWindowController {
    ...
    @FXML
    private TableColumn<Pair<Integer, Integer>, String> LocationLock;

    @FXML
    private TableColumn<Pair<Integer, Integer>, String> ValueLock;
    ...
    public void initialize() {
        ...
        LocationLock.setCellValueFactory(p -> new SimpleStringProperty(p.getValue().first.toString()));
        ValueLock.setCellValueFactory(p -> new SimpleStringProperty(p.getValue().second.toString()));
    }
