    ...
    private void displayProgram(ActionEvent actionEvent) {
        ...
        if (selectedStatement == null) {
            ...
            try {
                ...
                PrgState programState = new PrgState(new MyStack<>(), new MyDictionary<>(), new MyList<>(), selectedStatement, new MyDictionary<>(), new MyHeap(), new MySemaphoreTable());
        ...
        IStmt ex11 = new CompStmt(
                ...
                new CompStmt(
                        ...
                        new CompStmt(
                                ...
                                new CompStmt(
                                        new CreateSemaphoreStmt("cnt", new RHExp(new VarExp("v1"))),
                                        new CompStmt(
                                                new ForkStmt(
                                                        new CompStmt(
                                                                new AcquireStmt("cnt"),
