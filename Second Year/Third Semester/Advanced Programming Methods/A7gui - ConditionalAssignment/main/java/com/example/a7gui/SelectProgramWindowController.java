                                        ...
                                        new CompStmt(new NewStmt("b", new ValueExp(new IntValue(0))),
                                                new CompStmt(new WHStmt("a", new ValueExp(new IntValue(1))),
                                                        new CompStmt(new WHStmt("b", new ValueExp(new IntValue(2))),
                                                                new CompStmt(new CondAssignStmt("v", new RelExp("<", new RHExp(new VarExp("a")), new RHExp(new VarExp("b"))),
                                                                        new ValueExp(new IntValue(100)), new ValueExp(new IntValue(200))),
                                                                        new CompStmt(new PrintStmt(new VarExp("v")),
                                                                                new CompStmt(new CondAssignStmt("v", new RelExp(">", new ArithExp("-", new RHExp(new VarExp("b")), new ValueExp(new IntValue(2))), new RHExp(new VarExp("a"))),
                                                                                        new ValueExp(new IntValue(100)), new ValueExp(new IntValue(200))),
                                                                                        new PrintStmt(new VarExp("v"))))))))))));
        allStmts.add(ex11);
