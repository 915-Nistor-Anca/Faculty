        ...
        IStmt ex11 = new CompStmt(
                ...
                new CompStmt(
                        ...
                        new CompStmt(
                                ...
                                new CompStmt(new VarDeclStmt("cnt", new IntType()), new CompStmt(
                                        new NewStmt("v1", new ValueExp(new IntValue(2))),
                                        new CompStmt( new NewStmt("v2", new ValueExp(new IntValue(3))), new CompStmt(new NewStmt("v3", new ValueExp(new IntValue(4))),
                                                new CompStmt(new NewLatchStmt("cnt", new RHExp(new VarExp("v2"))),
                                                        new CompStmt(new ForkStmt(
                                                                new CompStmt(new WHStmt("v1", new ArithExp("*", new RHExp(new VarExp("v1")), new ValueExp(new IntValue(10)))),
                                                                                                new CompStmt(new PrintStmt(new RHExp(new VarExp("v1"))), new CompStmt(
                                                                                                                new CountDownStmt("cnt"), new ForkStmt(new CompStmt(
                                                                                                                        new WHStmt("v2", new ArithExp("*", new RHExp(new VarExp("v2")), new ValueExp(new IntValue(10)))),
                                                                                                        new CompStmt(
                                                                                                                new PrintStmt(new RHExp(new VarExp("v2"))), new CompStmt(
                                                                                                                        new CountDownStmt("cnt"), new ForkStmt(
