...
public class MainWindowController {
    ...
    @FXML
    private TableColumn<Pair<Integer, Integer>, Integer> LocationLatch;
    ...
    public void initialize() {
        ...
        LocationLatch.setCellValueFactory(p -> new SimpleIntegerProperty(p.getValue().first).asObject());
        ValueLatch.setCellValueFactory(p -> new SimpleIntegerProperty(p.getValue().second).asObject());
    ...
    private void populateLatchTableView() {
        ...
        LatchTable.setItems(FXCollections.observableArrayList(latchTableEntries));
    }
