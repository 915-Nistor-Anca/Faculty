...
public class PrgState {
    ...
    public PrgState(MyIStack<IStmt> stk, MyIDictionary<String, Value> symtbl, MyIList<Value> out, IStmt ogPrg, MyIDictionary<String, BufferedReader> fileTable, MyIHeap heap, MyILatchTable latchTable){
        this.stk = stk;
        this.symtbl = symtbl;
        this.out = out;
    ...
    public PrgState(MyIStack<IStmt> stack, MyIDictionary<String,Value> symTable, MyIList<Value> out, MyIDictionary<String, BufferedReader> fileTable, MyIHeap heap, MyILatchTable latchTable) {
        this.stk = stack;
